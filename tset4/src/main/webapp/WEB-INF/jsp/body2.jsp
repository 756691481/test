        ...
        <c:forEach items="${jobList}" var="job">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 top-margin">
                ...
                <div class="warp-border">
                    ...
                    <div class="clearfix">
                            <%--                        创建一个类--%>
                        <div class="icon-people"><img src="${pageContext.request.contextPath}${job.picture}"></div>
                            <%--                        创建一个类 内容是图片
                        <div class="text">
                                <%--                            创建一个类 --%>
                            <h4 class="">${job.name}</h4>
                                <%--                             第一栏 职业名称
                            <p class="text-present">${job.message}</p>
                                <%--                            第二栏  职业介绍
                        </div>
                    </div>
                    ...
                    <div class="warp-class2">
                        ...
                        <div class="warp-class2-text">
                            ...
                            <div class="iconfont text-padding">门槛
                                    <%--                                创建类  文字:门槛--%>
                                <c:forEach begin="1" end="${job.sill}">
                        ...
                        <div class="warp-class2-text">
                            ...
                            <div class="iconfont text-padding text-border-left">难易程度
                                ...
                                <c:forEach begin="1" end="${job.complexity}">
                                    <%--                                    创建一个表单 从 1开始由job.complexity结束 星星的个数--%>
                                    <img src="${pageContext.request.contextPath}/static/image/xx.png">
                    ...
                    <div class="warp-class2">
                        ...
                        <div class="warp-class2-text">
                                <%--                            创建一个类--%>
                            <div class="iconfont text-padding">成长周期 <span class="iconfont-color">${job.cycle}</span>年</div>
                                <%--                            创建一个类来形容成长周期  成长周期 多少年--%>
                        </div>
                        <div class="warp-class2-text">
                                <%--                            创建一个类--%>
                            <div class="iconfont text-padding text-border-left">稀缺程度 <span class="iconfont-color">${job.rareness}</span>家公司需要</div>
                                <%--                            创建一个类,来形容稀缺程度，--%>
                        </div>
                    </div>
                        ...
                        <div class="rightWarp">
                            ...
                            <div class="rightWarp-class">
                                ...
                                <div class="rightWarp-year">0-1年</div>
                                    <%--                                    第一种 0-1年--%>
                                <div class="rightWarp-wages">${job.payone}/月</div>
                                    <%--                                     第二个类来接受第一种薪资--%>
                            </div>
                            <div class="rightWarp-class">
                                    <%--                                创建一个类--%>
                                <div class="rightWarp-year">1-2年</div>
                                    <%--                                    创建一个类，1-2年--%>
                                <div class="rightWarp-wages">${job.paytwo}/月</div>
                                    <%--                                创建一个类 ，接受1-2年情况下的月薪--%>
                            </div>
                            <div class="rightWarp-class border-bottom">
                                ...
                                <div class="rightWarp-year">2-3年</div>
                                    <%--                                     创建一个类，2-3年的情况下--%>
                                <div class="rightWarp-wages">${job.paythree}/月</div>
                    ...
                    <div class="warp-class2">
                            <%--                        创建一个类--%>
                        <b class="text-b">有${job.studytotle}人正在学
                                <%--                            创建一个类来接受 有多少人正在学--%>
                            创建时间: <date: value="${job.creatat}"/>
                    ...
                    <div class="flip-container">
                            <%--                        创建类--%>
                        <p class="flip-title">${job.name}</p>
                            <%--                            创建一个类 接受职业--%>
                        <p class="flip-text">${job.message}</p>
                            <%--                        创建一个类，来接受职业的介绍--%>
                    </div>
                </div>
            </div>
