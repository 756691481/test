...
<div id="myCarousel" class="carousel slide">
    ...
    <ol class="carousel-indicators">
        ...
        <%--        //active 自定义导航栏当前高亮的栏目 data-slide-to是一个索引，他和轮播图一一对应，从零开始，控制轮播图的跳转位置--%>
    ...
    <div class="carousel-inner">
        ...
        <div class="item active">
            ...
            <%--            //图形属性 第一张属性 链接 根目录下的static目录下的image目录下 的547567.jpg文件--%>
        </div>
        <div class="item">
            <%--            第二个--%>
            <img alt="Second slide" src="${pageContext.request.contextPath}/static/image/453254354.jpg">
            <%--            //图形 第二张属性 链接 根目录下的 static目录下的image目录下的547567.jpg文件--%>
        </div>
        <div class="item">
            <%--            //第三个--%>
            <img alt="Third slide" src="${pageContext.request.contextPath}/static/image/banner-3.jpg">
            <%--            //图形 第三张属性  链接 根目录下的static的image下的547567.jpg文件--%>
        </div>
            ...
            <ul class="list-unstyled text-center" style="margin: 0;">
                ...
                <li class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    ...
                    <div>
                        ...
                        <span>${student.jobid}${student.job}:${student.name}</span>
                            <%--                        student.position(职业)对应student.name，一一对应--%>
                        <p class="text-left">${student.message}</p>
                            <%--                        文本靠左对齐，学生的经历--%>
                    </div>
                </li>
            </ul>
